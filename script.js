...
(function () {
  ...
  window.getStoredLeads = function () {
    ...
    console.group('%c🎯 DIGITAL MARKETING ACADEMY - STORED LEADS', 'color: #2563eb; font-weight: bold; font-size: 14px;');
    console.log(`Total Stored Leads: ${leads.length}`);
    if (leads.length > 0) {
      console.table(leads);
    } else {
      console.log('No leads found in localStorage yet. Submit the enquiry form to see leads recorded here.');
    }
    console.groupEnd();
    return leads;
  };
  ...
  window.clearStoredLeads = function () {
    ...
    console.log('%c🗑️ Stored leads cleared successfully from localStorage.', 'color: #ef4444; font-weight: bold;');
  ...
  // =========================================================================
  // 2. SMOOTH SCROLLING & CTA TRIGGERS
  // =========================================================================
      ...
      btn.addEventListener('click', function (e) {
        ...
        if (targetHref && targetHref.startsWith('#')) {
          ...
          if (targetSection) {
            ...
            if (specificCourse) {
              ...
              if (courseSelect) {
                ...
                for (let i = 0; i < courseSelect.options.length; i++) {
                  if (courseSelect.options[i].value.toLowerCase() === specificCourse.toLowerCase()) {
            ...
            // If navigating to enquiry form, highlight & focus the name field smoothly
            if (targetHref === '#enquire') {
              setTimeout(function () {
  ...
  function initEnquiryForm() {
    ...
    const summaryContainer = document.getElementById('submitted-summary-content');
    ...
    phoneInput.addEventListener('input', function () { validatePhone(phoneInput); });
    phoneInput.addEventListener('blur', function () { validatePhone(phoneInput); });

    courseSelect.addEventListener('change', function () { validateCourse(courseSelect); });
  ...
  function initLeadsModal() {
    ...
    if (clearBtn) {
      clearBtn.addEventListener('click', function () {
        if (confirm('Are you sure you want to clear all stored demo leads from localStorage?')) {
